...
def upgrade() -> None:
    ...
    op.add_column(
        "registros_valor", sa.Column("aprovado_por_id", sa.Integer(), nullable=True)
    )
    op.add_column(
        "registros_valor",
    ...
    op.add_column(
        "registros_valor", sa.Column("observacao_aprovacao", sa.Text(), nullable=True)
    )
    op.alter_column(
        "registros_valor",
        "created_at",
    ...
    op.create_foreign_key(
        None, "registros_valor", "colaboradores", ["aprovado_por_id"], ["id"]
    )
