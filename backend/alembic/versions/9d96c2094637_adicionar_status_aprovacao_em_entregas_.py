...
def upgrade() -> None:
    ...
    op.alter_column('colaboradores', 'updated_at',
               ...
               server_default=sa.text('now()'),
               existing_nullable=True)
    op.add_column('entregas_outstanding', sa.Column('status_aprovacao', sa.String(length=20), nullable=False))
    op.add_column('entregas_outstanding', sa.Column('aprovado_por_id', sa.Integer(), nullable=True))
    op.add_column('entregas_outstanding', sa.Column('aprovado_em', sa.DateTime(timezone=True), nullable=True))
    op.add_column('entregas_outstanding', sa.Column('observacao_aprovacao', sa.Text(), nullable=True))
    ...
    op.alter_column('entregas_outstanding', 'updated_at',
               ...
               server_default=sa.text('now()'),
               existing_nullable=True)
    op.create_foreign_key(None, 'entregas_outstanding', 'colaboradores', ['aprovado_por_id'], ['id'])
